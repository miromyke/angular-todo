var TodoStorage = require('./todo.storage'),
...
api = {
    ...
    deleteTodoFile:     onDeleteTodoFile
};
...
function onDeleteTodoFile(req, res, next) {
    TodoStorage.removeTodoFile(req.params.id, req.query.filePath, function (todo) {
        res.send(todo);
    });
}
